...
UCL Course COMP0133 LEC-08: Bayou
...
***<span style="color:Red">Two nodes may disagree on meaning of tentative (uncommitted) writes even if those two nodes have synced with each other</span>***

***<span style="color:Red">Only writes with CSNs from primary replica can resolve these disagreements permanently</span>***

***<span style="color:Red">Moreover, tentative order \\( \neq \\) commit order since CSN is determined by the order that Primary Replica receives writes</span>***
