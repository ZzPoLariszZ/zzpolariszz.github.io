...
- \\(Adv_{\mathcal{B}, \text{Gen}}^{DDH}(\lambda) = \| Pr[\mathcal{D}(\mathbb{G}, g, q, g^{x_1}, g^{x_2}, g^{x_1 x_2}) = 1] - Pr[\mathcal{D}(\mathbb{G}, g, q, g^{x_1}, g^{x_2}, g^y) = 1] \| = \| Pr[\text{Game}_{\mathcal{A}, \text{ElGamal}}^{\text{IND-CPA}}(\lambda) = 1] - \frac{1}{2} \| = Adv_{\mathcal{A}, \text{ElGamal}}^{IND-CPA}(\lambda)\\).

- \\(Adv_{\mathcal{A}, \text{ElGamal}}^{IND-CPA}(\lambda) = Adv_{\mathcal{B}, \text{Gen}}^{DDH}(\lambda) \leq negl(\lambda)\\).
