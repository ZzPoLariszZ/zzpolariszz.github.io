...
where \\(\text{Game}_{\mathcal{A}, \text{Gen}_{\text{RSA}}}^{\text{RSA}}(\lambda)\\):

1. Roles: Challenger and Adversary.

2. \\(\Big((e, n), (d, n) \Big) \xleftarrow{\$} \text{Gen}_{\text{RSA}}\\): Challenger generates \\((e, n), (d, n)\\) and keeps \\((d, n)\\), then sends \\((e, n)\\) to Adversary.
