...
UCL Course COMP0133 LEC-04: Transparency and RPC
...
`open()` could fail in NFS when the server is died or could be retried forever (timeout should be set by applications on client)
