...
One key problem of anonymity provided by Mix is **<span style="color:Red">the need to believe the Mix itself</span>**.

The solution is to use multiple Mixes.
...
$$
A \rightarrow \text{Mix}_2: \{ \ \text{Mix}_4: \{ \ \text{Mix}_1: \{B, \ \text{Msg} \ \}_{pk_{\text{Mix}_1}} \ \}_{pk_{\text{Mix}_4}} \ \}_{pk_{\text{Mix}_2}}
$$

The path is `A -> Mix_2 -> Mix_4 -> Mix_1 -> B`.
