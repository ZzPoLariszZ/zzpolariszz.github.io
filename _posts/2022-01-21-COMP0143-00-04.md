...
Let \\(H\\) be a Collision Resistant Hash Function (CRHF) in the Random Oracle Model (ROM) accepting arbitrary size inputs.
...
The *hiding* of CRHF-based Commitment provide  ***<span style="color:Red">Computational Security</span>*** since an adversary queries \\(H( \* \parallel r )\\) only with negligible probability.

The *binding* of CRHF-based Commitment provide  ***<span style="color:Red">Computational Security</span>*** since \\(H\\) is collision-resistant.
