...
- \\(\chi\\) Step: combines bits using a non-linear function (import non-linearity)
    ...
    $$
    \forall \, x \in \{0, 1, 2, 3, 4\}, \forall \, y \in \{0, 1, 2, 3, 4\}, \\ 
    \quad S[x][y] = S[x][y] \oplus \Big( \,(\neg \, S[x+1][y]) \land S[x+2][y] \, \Big)
    $$
...
- \\(\iota\\) Step: adds a round constant to the state (break symmetry)
    ...
    <table>
    <tbody><tr>
    <th>RC[0]</th><td>0x0000000000000001</td><th>RC[12]</th><td>0x000000008000808B</td>
    </tr>
    <tr>
    <th>RC[1]</th><td>0x0000000000008082</td><th>RC[13]</th><td>0x800000000000008B</td>
    </tr>
    <tr>
    <th>RC[2]</th><td>0x800000000000808A</td><th>RC[14]</th><td>0x8000000000008089</td>
    </tr>
    <tr>
    <th>RC[3]</th><td>0x8000000080008000</td><th>RC[15]</th><td>0x8000000000008003</td>
    </tr>
    <tr>
    <th>RC[4]</th><td>0x000000000000808B</td><th>RC[16]</th><td>0x8000000000008002</td>
    </tr>
    <tr>
    <th>RC[5]</th><td>0x0000000080000001</td><th>RC[17]</th><td>0x8000000000000080</td>
    </tr>
    <tr>
    <th>RC[6]</th><td>0x8000000080008081</td><th>RC[18]</th><td>0x000000000000800A</td>
    </tr>
    <tr>
    <th>RC[7]</th><td>0x8000000000008009</td><th>RC[19]</th><td>0x800000008000000A</td>
    </tr>
    <tr>
    <th>RC[8]</th><td>0x000000000000008A</td><th>RC[20]</th><td>0x8000000080008081</td>
    </tr>
    <tr>
    <th>RC[9]</th><td>0x0000000000000088</td><th>RC[21]</th><td>0x8000000000008080</td>
    </tr>
    <tr>
    <th>RC[10]</th><td>0x0000000080008009</td><th>RC[22]</th><td>0x0000000080000001</td>
    </tr>
    <tr>
    <th>RC[11]</th><td>0x000000008000000A</td><th>RC[23]</th><td>0x8000000080008008</td>
    </tr>
    </tbody>
    <caption><strong>The Round Constants RC[i]</strong></caption>
    </table>
