...
UCL Course COMP0133 LEC-05: Ivy
...
Execution gives same result as if one instruction is run at a time, waiting for each to complete before next instruction</span>**
...
<img src="Materials/mutual-exclusion.png" width="300" />
...
<img src="Materials/data-dependencies.png" width="300" />
...
*Drawback*: reduce the performance since many CPUs read the same page will not cause inconsistency (usually more read than write)
