...
UCL Course COMP0133 LEC-17: Host-Based Exploit Defenses
...
JIT: Applications generate codes while running, and then jump into the generated code (e.g., run-time type checking in JavaScript)
...
adversary may possibly be able to <span style="color:Red">detect monitored servers by their slow response time and avoid sending them exploit payload</span>
